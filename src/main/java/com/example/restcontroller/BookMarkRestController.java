...
public class BookMarkRestController {
    ...
    public Map<String, Object> selectlistGET(
        ...
        //------------------------------------오류 발생지점-----------------------
        @RequestParam(name="bmkno", defaultValue = "0", required = false) long bmkno ){  
            System.out.println(page);
            System.out.println(token);
            System.out.println(bmkno);
        Map<String, Object> map = new HashMap<>();
        ...
        try {
            ...
            List<BookMarkCHG> list = bmkService.bookmarkSelectList(pageable, bmkno);
            if(list != null){
                map.put("status", 200);
                map.put("result", list);
            }
